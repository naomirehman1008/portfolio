...
#define PACKET_HEAD 0xCC
#define PACKET_TAIL 0xB9
#define PACKET_END_0 0x0D
#define PACKET_END_1 0x0A
...
typedef struct Packet_Buffer {
    ...
    int tail;
    int buffer_size;
    rxpADT packet_arr[PACKETBUFFERSIZE];
    int is_full; 
    int is_empty;
    
} Packet_Buffer;

enum packet_state_machine{
    SCAN,
    PARSE_PACKET,
    HEAD,
    ID,
